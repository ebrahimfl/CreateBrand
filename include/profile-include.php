...
<section id="user_profile">
	<div class="container">
		<form action="<?php base_url('useer_profile/php/core.php') ?>" method="post" enctype="multipart/form-data">
			...
			<div class="profile_header">
				...
				<div class="profile_logo">
					...
					<img src="<?php base_url("assets/images/user/".$data['img']) ?>" name='img_logo' alt="" class="profile_logo">
